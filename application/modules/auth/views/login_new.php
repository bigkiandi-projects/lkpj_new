...
<head>
  ...
  <meta property="og:image" content="<?= base_url('assets/img/logos.jpg') ?>" />
  ...
  <meta name="thumbnailUrl" content="<?= base_url('assets/img/logos.jpg') ?>" itemprop="thumbnailUrl" />
...
<div class="container-fluid px-1 px-md-3 px-lg-1 px-xl-3 py-3 mx-auto">
    <div class="card card0 border-0">
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row">
                        <img src="<?= base_url('assets/img/logo-kop.png') ?>" class="logo img-fluid">
                    </div>
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line">
                        <img src="<?= base_url('assets/img/bg-depan-2.png') ?>" class="image">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="bg-blue py-4">
            <div class="row px-3">
                <small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2023. Badan Perencanaan All rights reserved.</small>
