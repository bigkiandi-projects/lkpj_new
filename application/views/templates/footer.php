...
<footer class="main-footer">
	<strong>Copyright &copy; 2023 Nazli Angkotasan, SE, MPA<a href="#"></a>.</strong> All rights reserved.
</footer>
...
<!-- nestablejs -->
<script src="<?php echo base_url('node_modules/nestable2/dist/jquery.nestable.min.js') ?>"></script>
<!-- iconpicker -->
<script src="<?php echo base_url('node_modules/fontawesome-iconpicker/dist/js/fontawesome-iconpicker.min.js') ?>"></script>
<!-- custom js -->
